...
export function rangeValueToHtml(
  ...
  // content (data, border, or conditional format). This stops select-all of a
  // mostly-empty sheet from emitting tens of thousands of blank <td>s. Trimmed cells
  // hold no data and no CSS, so the copy stays lossless (matches Google's used-range).
