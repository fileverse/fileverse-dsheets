...
[dsheets.new](http://dsheets.new/) is your end-to-end encrypted and sovereign alternative to Google Sheets & Excel. Use it to read, manipulate, and even write financial data, in real-time. Built on the same middleware as ddocs.new, the app is privacy-focused, decentralized, and gives you full control over your data <3 
...
- Granular access permissions (i.e., invite specific email addresses)
